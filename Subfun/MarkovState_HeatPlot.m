function [G,p]=MarkovState_HeatPlot(TransitionMatrix,CountsState,ComColor,ColorMapC,Clim)


%%%%%Plot Transition Matrix (n x n)and Occurrence (CountsState, n x 1) for n states
%%%%%ComColor (n x 3) is the node color for the n state 
%%%%%ColorMapC is the heatmap used for plot
%%%%%Clim is the color scale
