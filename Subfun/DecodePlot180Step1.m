function DecodePlot180Step1(Data,Geno,GenoName,ParamN,colorMapPN,SaveFolder1)
%%%%%%
...
%    plot([Zone(iZ) Zone(iZ)],[0 180],'w:','linewidth',0.8); 
   plot([Zone(iZ) Zone(iZ)],[0 180],':','color',[240 100 0]/255,'linewidth',0.8); 

end

grid off;
set(gca,'clim',[0.5 1.8],'xtick',[0:90:180],'xticklabel',[],'ytick',[0:90:180],'yticklabel',[],'tickdir','out');
colormap(bone)
papersizePX=[0 0 3 3];
...
set(gca,'xtick',[0:90:180],'ytick',[0:90:180]);
set(gca,'clim',[-0.4 0.4],'xtick',[0:90:180],'xticklabel',[],'ytick',[0:90:180],'yticklabel',[],'tickdir','out');
hold on;
for iZ=1:length(Zone)
    plot([Zone(iZ) Zone(iZ)],[0 180],'k:','linewidth',0.8); 
end
grid off;
